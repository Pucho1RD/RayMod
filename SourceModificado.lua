...
function RayfieldLibrary:CreateWindow(Settings)
	...
	function Window:CreateTab(Name, Image, Ext)
		...
		function Tab:CreateMultiDropdown(DropdownSettings)
			local Dropdown = {Value = DropdownSettings.CurrentOption or {}, Options = DropdownSettings.Options}
			...
			DropdownFrame.Name = DropdownSettings.Name .. " _MultiDropdown"
			...
			OptionsContainer.Position = UDim2.new(0, 10, 0, 44)
			...
			DropdownBtn.MouseButton1Click:Connect(function()
				...
				if Toggled then
					...
					DropdownFrame:TweenSize(UDim2.new(1, -10, 0, 160), "InOut", "Quart", 0.2, true)
					OptionsContainer:TweenSize(UDim2.new(1, -20, 0, 100), "InOut", "Quart", 0.2, true)
				else
					DropdownFrame:TweenSize(UDim2.new(1, -10, 0, 44), "InOut", "Quart", 0.2, true)
					OptionsContainer:TweenSize(UDim2.new(1, -20, 0, 0), "InOut", "Quart", 0.2, true)
			...
			local function RenderOptions()
				...
				for _, optionName in ipairs(Dropdown.Options) do
					...
					if SelectedOptions[optionName] then
						OptionBtn.BackgroundColor3 = Color3.fromRGB(0, 125, 255)
					...
					OptionBtn.MouseButton1Click:Connect(function()
						...
						pcall(DropdownSettings.Callback, CurrentSelection)
						RenderOptions()
					end)
				end
			end
